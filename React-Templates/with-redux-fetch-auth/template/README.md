...
"With Redux Fetch and Authentication"
****************************************** 
First:
...
npm i redux react-redux redux-thunk prop-types react-bootstrap (only install bootstrap if you want to use it for sing-up styling)
npm i --save history
npm i --save react-router-dom

....and for server:

npm i express mongoose body-parser cors dotenv bcrypt-nodejs jwt-simple
